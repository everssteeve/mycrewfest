...
const FUTURE1: TrendingFestivalItem = {
  id: "1", name: "Hellfest", slug: "hellfest-2026",
  city: "Clisson", country: "France",
  startDate: "2026-06-18T00:00:00.000Z", endDate: "2026-06-21T00:00:00.000Z",
  festivalType: "musique", followerCount: 150,
};
const FUTURE2: TrendingFestivalItem = {
  id: "2", name: "Solidays", slug: "solidays-2026",
  city: "Paris", country: "France",
  startDate: "2026-06-26T00:00:00.000Z", endDate: "2026-06-28T00:00:00.000Z",
  festivalType: "musique", followerCount: 80,
};
const PAST: TrendingFestivalItem = {
  id: "3", name: "Festival Passé", slug: "festival-passe",
  city: "Lyon", country: "France",
  startDate: "2025-08-01T00:00:00.000Z", endDate: "2025-08-03T00:00:00.000Z",
  festivalType: "cirque", followerCount: 999,
};
const FUTURE3: TrendingFestivalItem = {
  id: "4", name: "Vieilles Charrues", slug: "vieilles-charrues-2026",
  city: "Carhaix", country: "France",
  startDate: "2026-07-15T00:00:00.000Z", endDate: "2026-07-18T00:00:00.000Z",
  festivalType: "musique", followerCount: 200,
};
...
describe("selectTrendingFestivals", () => {
  ...
  it("filters out festivals starting exactly at now (boundary: startDate >= now)", () => {
    const exactly: TrendingFestivalItem = {
      ...FUTURE1, id: "exact", startDate: NOW.toISOString(),
    };
...
describe("formatFestivalTypeLabel", () => {
  ...
  it("formats théâtre_rue", () => expect(formatFestivalTypeLabel("théâtre_rue")).toBe("Théâtre de rue"));
  ...
  it("formats multidisciplinaire", () => expect(formatFestivalTypeLabel("multidisciplinaire")).toBe("Multi"));
